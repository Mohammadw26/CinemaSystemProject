...
public class PurchaseHistoryController {
    ...
    void CancelPurchase(ActionEvent event) {
    	...
    	try {
    		if (unregClient!=null)
    			...
    			SimpleClient.getClient().sendToServer(new Message("#CancelOrder", DisplayListController.getMember(), temp));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    void initialize() {
        assert loginAnchor != null : "fx:id=\"loginAnchor\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert loginAnchorLabel1 != null : "fx:id=\"loginAnchorLabel1\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert oldUserField != null : "fx:id=\"oldUserField\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert oldPasswordField != null : "fx:id=\"oldPasswordField\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert loginAnchorLabel2 != null : "fx:id=\"loginAnchorLabel2\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert logInButton != null : "fx:id=\"logInButton\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert logOutButton != null : "fx:id=\"logOutButton\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert invalidLogin != null : "fx:id=\"invalidLogin\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert loginAnchor1 != null : "fx:id=\"loginAnchor1\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert loginAnchorLabel11 != null : "fx:id=\"loginAnchorLabel11\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert clientID != null : "fx:id=\"clientID\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert cardDigits != null : "fx:id=\"cardDigits\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert loginAnchorLabel21 != null : "fx:id=\"loginAnchorLabel21\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert logInButton1 != null : "fx:id=\"logInButton1\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert logOutButton1 != null : "fx:id=\"logOutButton1\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert invalidLogin1 != null : "fx:id=\"invalidLogin1\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert welcomeLabel != null : "fx:id=\"welcomeLabel\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        assert historyTable != null : "fx:id=\"historyTable\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
        ...
        assert transactionID != null : "fx:id=\"transactionID\" was not injected: check your FXML file 'purchaseHistory.fxml'.";
    	...
    	if (DisplayListController.getMember()!=null && status == 0) {
    		...
    		welcomeLabel.setText(DisplayListController.getMember().getFirstName() + " " + DisplayListController.getMember().getLastName());
